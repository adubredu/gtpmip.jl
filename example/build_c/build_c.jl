...
grounded_plan = solve_hpd("example/build_c/domain.hpd", "example/build_c/problem.hpd"; max_levels=300)
grounded_plan.plan
...
println("visualizing...")
visualize_trajectory!(bobby, traj, obj_traj, obs_dict, ax, fig;name="media/build_c.gif")
