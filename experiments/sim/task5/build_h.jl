...
grounded_plan = solve_hpd("example/build_h/domain.hpd", "example/build_h/problem.hpd"; max_levels=300)
grounded_plan.plan
...
println("visualizing...")
visualize_trajectory!(bobby, traj, obj_traj, obs_dict, ax, fig;name="media/build_h.gif")
