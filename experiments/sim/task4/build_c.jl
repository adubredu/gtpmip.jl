...
grounded_plan = solve_hpd("experiments/sim/task4/domain.hpd", "experiments/sim/task4/problem.hpd"; max_levels=300)
1
# grounded_plan.plan
...
# @time visualize_trajectory!(bobby, traj, obj_traj, obs_dict, ax, fig;name="media/build_c.gif")
