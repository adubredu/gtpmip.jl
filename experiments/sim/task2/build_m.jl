...
grounded_plan = solve_hpd("example/build_m/domain.hpd", "example/build_m/problem.hpd"; max_levels=1000)
grounded_plan.plan
...
println("visualizing...")
visualize_trajectory!(bobby, traj, obj_traj, obs_dict, ax, fig;name="media/build_m.gif")
