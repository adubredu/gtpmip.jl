...
grounded_plan = solve_hpd("example/build_i/domain.hpd", "example/build_i/problem.hpd"; max_levels=200)
grounded_plan.plan
...
println("visualizing...")
visualize_trajectory!(bobby, traj, obj_traj, obs_dict, ax, fig;name="media/build_i.gif")
